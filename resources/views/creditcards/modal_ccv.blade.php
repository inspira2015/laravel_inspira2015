			...
			<div class="modal-wrapper">
				...
				<div class="row">
					<div class="col-sm-5">
						...
						<div class="row">
							<img src="http://inspiramexico.mx/cvv/cvv-visa.gif" style="margin-left:50px; margin-top:10px;margin-bottom:10px;width:100%;">
						</div>
						<div class="row">
					...
					<div class="col-sm-5">
						...
						<div class="row">
							<img src="http://inspiramexico.mx/cvv/cvv-amex.gif" style="margin-left:50px;width: 215px; height: 103px;margin-top:10px;margin-bottom:10px;width:100%;">
						</div>
						<div class="row">
