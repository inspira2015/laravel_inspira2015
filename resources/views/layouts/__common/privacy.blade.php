    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<div class="row text-justify">
			...
			2. Inspira Mexico puede utilizar la información personal que nos proporciona para ofrecerle un mejor servicio y, en su caso, identificar sus preferencias durante su estancia y hacerla más placentera.<br />
			3. Asimismo, puede utilizar la información para ofrecerle promociones y productos turísticos y comerciales en general, así como cualquier otro producto o servicio relacionado como puede ser en forma ejemplificativa más no limitativa el envío de promociones, servicios especiales, boletines informativos, encuestas y otros productos y servicios del Hotel.<br />
			4. Inspira Mexico puede compartir o transmitir la información con asociados o con terceros para que puedan enviarle información acerca de sus productos y servicios en general.<br />
			5. Finalmente la información que nos proporciona podrá ser tratada en los casos que expresamente autoriza el artículo 10 de la Ley Federal de Protección de Datos Personales en Posesión de Particulares.<br />
			<h5>C. Datos Personales</h5>
			Para los fines señalados en el presente Aviso de Privacidad, Inspira Mexico podrá recabar sus datos personales de diversas formas:<br />
			1. Cuando la información es proporcionada directamente por Usted.<br />
			2. Cuando usted visita el portal en internet de Inspira Mexico.<br />
			...
			Usted podrá limitar en cualquier momento que a la información que proporciona a Inspira Mexico, se de el tratamiento señalado en los numerales 3 y 4 del inciso B), mediante una solicitud que deberá ser presentada por escrito al departamento de contabilidad de contratos al siguiente domicilio: Calle Alta Tension #228, Ampliación Ejido Mazatlan, Playas de Rosarito CP 22710 desde 9 AM a 5 PM horas de Tijuana de lunes a sábado o al correo electrónico: contralor@inspiramexico.mx<br />
			Dicha solicitud deberá contener cuando menos lo siguiente: (i) nombre del titular de los datos personales; (ii) correo electrónico para recibir notificaciones; (iii) documentos que acrediten su identidad o, en su caso, la representación legal del titular; (iv) descripción clara y precisa de los datos personales respecto de los que se busca ejercer el derecho y del derecho que se pretende ejercer. (v) cualquier otro elemento o documento que facilite la localización de los datos personales. Con la finalidad de proteger su confidencialidad, Inspira Mexico enviará la respuesta a su solicitud al correo electrónico que haya proporcionado para tal fin y la conservará a disposición del solicitante en el domicilio señalado en el párrafo anterior.<br />
