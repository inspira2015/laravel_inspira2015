...
<div class="container">
    ...
    <div class="row"  style="margin-bottom:50px; background-color:#e5e7e9; margin-bottom:100px;">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <h2 style="padding-bottom:20px;"> {{  @$name }}  </h2> 
            <p>
...
<form method="post" action="?route=users/addfondo" id="profile" name="formulario">
          ...
          <h2>{{ Lang::get('vacationfund.questionjoin') }}</h2>
          <div class="inputs" >
          {{ Lang::get('vacationfund.yes') }}<input type="radio" name="fondo" value=1 id="fondo2" checked="checked"  onclick="clicked(this)"/>
          {{ Lang::get('vacationfund.no') }}<input type="radio" name="fondo" id="fondo1" value=0  onclick="clicked(this)"/>
</div>
<h2>{{ Lang::get('vacationfund.savingamount') }}</h2>
...
<div class="col-lg-12 col-md-12" style="padding:20px;">
  <p style="text-align:left;">
	{!! Lang::get('vacationfund.termsconditions') !!}
          ...
          <a href="?route=users/gotoAfiliacion" ><img style="width:50%; height:auto;"src="images/regresartransparente.png"/></a></div>
          <div class="col-lg-4 col-md-4 col-sm-4">&nbsp;</div>

          <div class="col-lg-4 col-md-4 col-sm-4" style="margin-bottom:50px;">   
          <a href="#" onClick="validateForm()"><img style="width:50%; height:auto;"src="images/continuar.png"/></a></div>
